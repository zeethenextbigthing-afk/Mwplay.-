...
// ─── SONG PAGE ────────────────────────────────────────────────────────────────
function SongPage({song,onPlay,isPlaying,isActive,currentUser,onLike,allSongs,toast,onShare,onDownload,onAddToPlaylist,addNotif,onFollow,artists}){
    ...
    <div style={{fontFamily:"'DM Sans',sans-serif",background:T.bg,color:T.text,minHeight:"100vh",position:"relative",overflow:"hidden"}}>
      ...
      <div style={{position:"relative",height:"100vh",overflow:"hidden"}}>
        ...
        <PageSlide show={showSongPage}>
          ...
          {openSong&&<SongPage song={openSong} onPlay={playSong} isPlaying={isPlaying} isActive={currentSong?.id===openSong.id} currentUser={currentUser} onLike={handleLike} allSongs={approvedSongs} toast={toast} onShare={setShareTarget} onDownload={handleDownload} onAddToPlaylist={setAddToPlaylistTarget} addNotif={addNotif} onFollow={handleFollow} artists={registeredUsers}/>}
        </PageSlide>
