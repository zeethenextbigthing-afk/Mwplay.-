      ...
      <div style={{padding:"20px 22px",maxHeight:"70vh",overflowY:"auto"}}>
        ...
        {tab==="editprofile"&&<>
          ...
          <Btn full onClick={async()=>{
            ...
            // If avatar is a data URL (new photo picked), upload to Supabase Storage
            ...
            const updated={...currentUser,bio,avatar:avatarUrl};
            onUpdateUser(updated);
            // Persist bio + avatar to Supabase profiles table
            if(isSupabaseReady){
